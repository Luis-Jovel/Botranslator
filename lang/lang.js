(function() {
  ...
  lang = {
    ...
    es: {
      ...
      send_instructions: "Traduciré los mensajes que envíes. Actualmente estoy traduciendo de %s a %s, escribe \"cambiar\" o \"intercambiar\" para traducir de %s a %s y vice versa",
    ...
    en: {
      ...
      send_instructions: "I'll translate messages you send. Currently I'm translating from %s to %s, write \"switch\" or \"change\" to translate from %s to %s or the other way around",
